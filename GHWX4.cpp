/** =========================================================================
 * @file GHWX4.cpp
 * @brief Example for GreenHouse monitoring using Mayfly v1.1 board.
 *
 ...
 * AM2315C Digital Humidity and Temperature Sensor
 *
 * This code is adapted from an example for the Mayfly v1.0 board.
 * It has been updated to work with the Mayfly v1.1 board and includes
 * additional sensors and configurations.
 *
 * @note This example is based on the ModularSensors library and is intended
 *       for use with the EnviroDIY Mayfly Arduino Datalogger.
 *
 *  editor Brian Jastram
 * @date 2025
 * 2025 Brian Jastram
 * 
 * DISCLAIMER:
...
Variable* sht4xHumid =
    new SensirionSHT4x_Humidity(&sht4x, "478413da-8244-4d34-855e-7c74b390e7ad");
Variable* sht4xTemp =
...
// ==========================================================================
//  AM2315(c) - BJ Digital Humidity and Temperature Sensor
// ==========================================================================

#include <AM2315C.h>

// Define communication interface (example)
TwoWire* wire = &Wire;

// Initialize AM2315C as a Sensor
AM2315C am2315c(sensorPowerPin, wire);

// Create Variable instances using the correct parent class
AM2315C_Temp_Var am2315cTemp(&am2315c, "65d7964a-5bfd-4afd-a7d4-f1f677993ff1");
AM2315C_Humidity_Var am2315cHumid(&am2315c, "478413da-8244-4d34-855e-7c74b390e7ad");
...
Variable *variableList[] = {
    new ProcessorStats_Battery(&mcuBoard),       // Battery voltage (ProcessorStats_Battery)
    ...
    new AM2315C_Temp_Var(&am2315c),              // Temperature (AM2315C_Temp)
    new AM2315C_Humidity_Var(&am2315c),          // Relative humidity (AM2315C_Humidity)
};
...
const char *UUIDs[] =                                                      // UUID array for device sensors
{
    ...
    "7b1df8a7-9115-462f-a802-85b7b04b8c21",   // Temperature (Sensirion_SHT40_Temperature)
    "5c5f2d60-497c-4c34-b6fb-6c074a56b200",   // Temperature (AM2315C_Temp)
    "0af7a334-7200-4ade-853d-09c66afb6f58"    // Relative humidity (AM2315C_Humidity)
};
...
void setup() {
    ...
    if (am2315c.begin()) {
        Serial.println("AM2315C sensor initialized successfully.");
    } else {
        Serial.println("Failed to initialize AM2315C sensor.");
    }
